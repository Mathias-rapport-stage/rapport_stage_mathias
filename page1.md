...
Cette entreprise est une entreprise de sevices informatiques.

__Depuis quand existe-t-elle ?__

Cette entreprise existe depuis 1 ans et 6 mois. cette entreprise est récente car avant elle faisait partie de HP qui s'est séparé de cette partie.
...
Cette entreprise est d'une administration multi-nationale.
...
Les clients sont souvent des entreprises.
...
ensuite j'ai fait un petit programme pour un robot informatique et non mécanique, quand je lui disais certaine chose comme ping il me répondait pong et je pouvais aussi lui posait des question basique et il me répondait. Après ça mon responsable de stage ma dit qu'il me ferait coder mon rapport en language Markdown sur un outil que lui et son équipe utilise souvent qui se nomme Visual Studio Code j'ai donc retranscrit tout mon rapport en Markdown dans Visual Studio Code.

**Jour2 :**

Le deuxième jour j'ai eu un entretien avec un technicien informatique son métier consiste à donner des PC lorsqu'il ne fonctionne plus où qu'il on un problème. Une personne l'a appelé car son PC recevai plein de message d'erreur, le technicien a trouvé d'où venai le problème c'est parce que cet personne avai commandé un PC mais quel n'été ajmais venu le chercher et à chaque fois qu'il donne un nouveau PC il ferme l'ancien. L'après midi j'ai eu un autre entretien avec un technicien informatique qui est aussi ingénieur réseau il en myITsupport et services ce qui veut dire qu'il est là pour aidé ceux qui ont des problèmes avec leur PC, après quelques minutes d'attente un homme est venu nous voir car il avait un problème audio venant des driver(driver : librairie permettant de "parler" à un composant du PC ici au périphérique audio) le technicien a du fouiller dans les fichier, chercher sur internet et désinstaller de driver pour que l'audio remarche bien.

**Jour3 :**

Le troisième jour j'ai eu un rendez-vous avec un consultant d'avant vente son métier consiste à donner des assets(ici asset électronique qui regroupe tout le domaine de l'informatique ex : PC, téléphone, routeur, application) aux entreprises pour quelles puissent travailler avec ces assets sont limités en temps les employés de l'entreprise ne peuvent pas dépasser le délai qui a été fourni. Son autre "casquette" est qu'il est chef de projet (d'asset) ce qui consiste à mettre en place les projets des entreprises et recevoir les appelles d'offres d'entreprises et les accepter et faire en sorte que l'entreprise ai tout se qu'il lui faut dans le délai et aussi parler du prix. Ensuite j'ai essayé de comprendre un petit programme de trie de nombre en langage go c'était assez compliqué mais au final j'ai quand même réussi à comprendre.

**Jour4 :**

Le quatrième jour j'ai visité un data center (centre de donnée) ce data center est très puissant et très grand sur une échelle de 4 tier ce data center est noté comme tier 3, il consomme autant en électricité qu'une ville de 4000 habitants ce data center est séparé en 2 grandes salles : Saumur et Amboise. L'arrivé électrique pour alimenter chacune des 2 salles et de 20000 volt, avec autant d'électricité les serveur peuvent vite surchauffés. il utilise donc un système de refroidissement appelé le dry cooler qui laisse refroidir des cuves d'eau et qui ne sont utilisé quand hiver en dessous de 8°C, elles servent comme les autres cuves utilisées toute l'année à refroidir la climatisation. Dans la salle Amboise l'eau passe par des gros tuyeaux sous le faux plancher pour aller dans le couloir de climatisation et refroidir les serveurs en passant par le faux plancher. A Saumur il n'y a pas de faux plancher l'eau fait le même chemin que la salle Amboise mais le couloir de climatisation soufle par dérrière les serveur. Comme ces salles sont bien équipés elles bénéficies du même équipement toutes les 2, elles sont très bien équipés surtout en therme de sécurité incendie elles disposent toutes les 2 d'un tuyaux avec des troues pour filtrer l'air tout le temps et détecté la moindre fumée si il y aurait de la fumée un signal s'envairait et une machine verrifirait et si il y a un feu les sprincler se déclanche pour envoyer de l'eau partout et éteindre le feu. Il y a aussi un renouvelement d'air constant. Ce data center doit être en état de marche 99,742% du temps en une année et pour que cela soit le cas des batteries de secours et des groupes électrogènes ces groupes électrogènes sont alimenteés an fuel leur réserve de fuel leur permet de tenir environ 72 heures d'autonomie, son prévus aussi des UPS(onduleur) qui servent à garder le courant au bon niveau, les serveurs son alimentés par des gaines électriques qui passent par le faux plancher. Cet endroit est très sécurisé il y a une centaine de caméra et pour y acceder il faut un badge et que la personne pose sa main sur une machine pour reconaitre la biométrie (la forme) de sa main , cet endroit endroit est très sécurisé car il ya des milliers de Terra de données et des machines qui valent des millions d'euro.


L'après-midi j'ai eu un entretien avec une personne qui travail dans la supply chain(la supply chain est l'ensemble des processus pour créer quelque chose ) de HP ink. HP ink est une entreprise qui fabrique des PC portable, fixe et des imprimantes 
.HP ink comprend 55000 employés partout dans le monde répartit dans les différentes entreprises HP ink, cette entreprise est si grande que son d'affaire par ans est de 58000000000 $. La personne avec qui j'ai eu l'entretien s'occupe d'une d'une supply chain en République Tchèque, elle s'occupe que les commande soit délivrer dans les temps et que les composant ne coûte pas trop cher à importer, car toutes les pièces vinnent d'Asie c'est pour cela que certaines pieces son importés en avion qui a un coût important mais qui arrive en 1 semaine, soit en train ce qui un peu moins cher mais qui arrive en 3 semaine, soit en bâteau qui est le moyen de transport le moins coûteux mais les composants mettent 5 semaine à arriver.



Ensuite j'ai eu un dernier entretien avec une personne qui travail dans les ressources humaines, le métier de cette personne consiste à mettre en place la politique et les processus pour que les employés soit performant et competant. Son métier consiste aussi à mettre les gens au bonne endroit suivant leurs compétances, leur qualités et leur niveau. Par exemple si un manager se plaint que son employé n'est pas fait son boulot à temps les ressources humaines vont demander comment le manager a accompagné son employé et essayer de comprendre pourquoi l'employés n'a pas fait son boulot a temps. La personnes des ressources humaines que j'ai rencontrerne s'occupe que de Lyon et Grenoble mais elle est en relation avec des ressources humaines d'autres pays pour mettre en commun leurs projets.
...
J'ai découvert plein de métier différent qui mon tous autant plus les un que les autres.

Ce qui m'a surpris : 

Ce qui ma surpris c'est que l'entreprise soit aussi grande et qu'il ai des contacts avec des personnes à l'étrangers.
...
La seul chose qui ma déçu c'est que je n'est pas eu accès à tout les bâtiments.

J'ai particulièrement apprécié ...

J'ai particulièrement apprécié la visite du data center car c'était très grand et très interressant, j'ai appris plein de chose sur les data center et je sais maintenant comment sont stocké des milliers de Terra.

J'aimerais (je n'aimerai pas travailler dans cette entreprise car ...) 

J'aimerais beaucoup travailler dans cette entreprise il y a une très bonne ambiance et que tout est interressant dans cette entreprise.

Le stage a changé (n'a pas changé) mon projet professionnel. Expliquez.	

Je ne sais pas vraiment si ce stage a changé mon projet proffesionnel ou pas mais j'ai adorer le faire car j'y ai découvert plein de chose et j'aime beaucoup l'imformatique donc il est possible que plus tard je m'oriente vers cette voie. 
